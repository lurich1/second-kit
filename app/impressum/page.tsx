...
export const metadata = {
  title: "Impressum | 3 Seconds Kitchen",
  description: "Rechtliche Informationen und Kontaktdaten von 3 Seconds Kitchen - FlavorBytes GmbH",
}
          ...
          <div className="prose prose-invert prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-primary max-w-none space-y-8">
            ...
            <section className="bg-card p-6 rounded-lg border border-border">
              ...
              <div className="space-y-2 text-muted-foreground">
                ...
                <p><strong className="text-foreground">Geschäftsbezeichnung:</strong> 3 Seconds Kitchen</p>
